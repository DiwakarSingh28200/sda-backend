...
exports.DealerSchema = zod_1.z.object({
    ...
    gps_location: zod_1.z.string().optional(),
    ...
    pan_number: zod_1.z.string().min(6, "PAN number must be 6 characters"),
    gst_number: zod_1.z.string().min(1),
    dealer_id: zod_1.z.string().optional(),
    password: zod_1.z.string().optional(),
    login_enabled: zod_1.z.boolean().optional().default(false),
    created_by: zod_1.z.string().uuid().optional(),
    created_at: zod_1.z.string().datetime().optional(),
    parent_dealer_id: zod_1.z.string().uuid().optional(),
    is_sub_dealer: zod_1.z.boolean().optional().default(false),
    is_master_dealer: zod_1.z.boolean().optional().default(false),
    is_email_verified: zod_1.z.boolean().optional().default(false),
    is_contact_verified: zod_1.z.boolean().optional().default(false),
...
exports.ServiceSchema = zod_1.z.object({
    ...
    night_charge: zod_1.z.number().optional(),
    day_charge: zod_1.z.number().optional(),
    fixed_distance_charge: zod_1.z.number().optional(),
    additional_price: zod_1.z.number().optional(),
});
...
exports.FinanceInfoSchema = zod_1.z.object({
    ...
    finance_contact_name: zod_1.z.string().optional(),
    finance_contact_email: zod_1.z.string().optional(),
    finance_contact_phone: zod_1.z.string().optional(),
